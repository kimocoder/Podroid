        ...
        when {
            ...
            subenc == 128 -> {
                ...
                while (filled < total) {
                    ...
                    while (runLen > 0) {
                        val remRun = minOf(runLen, tw - currCol)
                        Arrays.fill(target, (ty + currRow) * stride + tx + currCol, (ty + currRow) * stride + tx + currCol + remRun, color)
                        runLen -= remRun
                        filled += remRun
                        currCol = 0
                        currRow++
            ...
            subenc in 130..255 -> {
                ...
                while (filled < total) {
                    ...
                    if (indexByte and 0x80 == 0) {
                        ...
                        val row = filled / tw; val col = filled % tw
